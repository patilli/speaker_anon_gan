...
class Visualizer:
    ...
    def visualize_speaker_embeddings(self, list_of_generated_embeddings, list_of_original_embeddings, title_of_plot, save_file_path=None, legend=True, colors=None):
        label_list = list()
        embedding_list = list()
